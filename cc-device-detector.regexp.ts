 ...
 * @desc All regex constants are declared in this file.
 */

export const OS_REG: any = {
  WINDOWS: /^(?!.*\bWindows Phone\b).*(\bWindows|(Win\d\d)\b|\bWin 9x\b).*$/,
  MAC: /^(?!.*(\biPhone\b|\biPad\b|\biPod\b|\bWindows Phone\b)).*\bMac OS\b.*$/,
  IOS: /^(?!.*\bWindows Phone\b).*(\biPad\b|\biPhone\b|\biPod\b).*$/,
  ANDROID: /^(?!.*\bWindows Phone\b).*\bAndroid\b.*$/,
  LINUX: /\bLinux\b/,
  UNIX: /\bUNIX\b/,
  FIREFOX_OS: /(?=.*\bFirefox\b)(?=.*Mobile\b).*/,
  CHROME_OS: /\bCrOS\b/,
  WINDOWS_PHONE: /(\bIEMobile\b|\bWindows Phone\b)/,
  PS4: /\bMozilla\/5.0 \(PlayStation 4\b/,
  VITA: /\bMozilla\/5.0 \(Play(S|s)tation Vita\b/,
};

export const BROWSERS_REG: any = {
  CHROME: /^(?!.*(\bOPR\b|\bEdg(e|A|iOS)\b|\bEdg\/\b|\bSamsungBrowser\b|\bUCBrowser\b)).*(\bChrome\b|\bCriOS\b|\bHeadlessChrome\b).*$/,
  FIREFOX: /(\bFirefox\b|\bFxiOS\b)/,
  OPERA: /(Opera\b|\bOPR\b)/,
  IE: /(\bMSIE\b|\bTrident\b|^Mozilla\/5\.0 \(Windows NT 10\.0; Win64; x64\)$)/,
  ...
  SAFARI: /^(?!.*(\bOPR\b|\bEdg(e|A|iOS)\b|\bEdg\/\b|\bWindows Phone\b|\bSamsungBrowser\b|\bUCBrowser\b)).*^((?!CriOS).)*\Safari\b.*$/
};

export const MOBILES_REG = {
...
export const DEVICES_REG: any = {
  FIREFOX_OS: /(?=.*\bFirefox\b)(?=.*\bMobile\b).*/,
  CHROME_BOOK: /\bCrOS\b/,
  MI_SE_9: /\bXiaomi\b/,
  MAC: /^(?!.*(\biPhone\b|\biPad\b|\biPod\b|\bWindows Phone\b)).*\bMac OS\b.*$/
};

export const OS_VERSIONS_REG: any = {
  WINDOWS_3_11: /Win16/,
  ...
  WINDOWS_NT_4_0: /^(?!.*Windows NT 10.0).*(Windows NT 4.0|WinNT4.0|WinNT|Windows NT).*$/,
  ...
  MACOSX_17: /(Mac OS X 10.17)/,
  MACOSX_18: /(Mac OS X 10.18)/,
  MACOSX_19: /(Mac OS X 10.19)/,
  MACOSX_11_0: /(11_0 like Mac OS X|Mac OS X 11)/,
...
export const BROWSER_VERSIONS_REG: any = {
